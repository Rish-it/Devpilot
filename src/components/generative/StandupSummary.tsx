    ...
    <div className="neu-shell">
      <div className="neu-shell-header">
        <div className="flex-1 min-w-0">
          <h1 className="neu-shell-title">Standup Summary</h1>
          <p className="neu-shell-subtitle">
            {props.repoName} &middot; {props.date}
          </p>
        </div>
        <span className="neu-shell-badge">Daily</span>
      </div>
                  ...
                  <div key={i} className="flex items-start gap-3 group">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <a href={c.url} target="_blank" rel="noopener noreferrer" className="neu-sha">
                          {c.sha.slice(0, 7)}
                        </a>
