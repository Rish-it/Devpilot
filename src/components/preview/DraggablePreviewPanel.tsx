    ...
    useEffect(() => {
        const handleMouseMove = (e: MouseEvent) => {
            ...
            if (isResizing && containerRef.current) {
                ...
                const newWidth = Math.max(400, e.clientX - rect.left + position.x);
                const newHeight = Math.max(300, e.clientY - rect.top + position.y);
                ...
                <div className="panel-content">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="w-full max-w-md space-y-3 mt-4">
                            ...
                            <div
                                className="h-32 rounded-lg animate-shimmer"
    ...
    if (component) {
        return (
            ...
            >
                ...
                {/* Content */}
                <div className="panel-content">{component}</div>
                ...
                <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="relative z-10 flex flex-col items-center gap-4 rounded-2xl border border-[#e6e2d9]/50 bg-card px-10 py-10 shadow-lg">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-muted-foreground max-w-[260px]">
                                    Components will appear here as you chat. Try a suggestion to
                                    get started.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 max-w-md">
                        {[
                            ...
                            <span key={name} className="landing-card-badge">
                                {name}
                            </span>
                        ))}
                    </div>
